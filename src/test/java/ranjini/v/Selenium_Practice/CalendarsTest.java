...
//		rightArrow
		...
		// 2000
		// //button[text()='2000']
		WebElement Year2000 = driver.findElement(By.xpath("//button[text()='2000']"));
		Year2000.click();
		
		// December
		// abbr[text()='December']
		WebElement December = driver.findElement(By.cssSelector("button.react-calendar__tile.react-calendar__year-view__months__month abbr[aria-label='December 2000']"));
		December.click();
		
		
		// 20th
		// //abbr[text()=20]
		WebElement date20th = driver.findElement(By.cssSelector("button.react-calendar__tile.react-calendar__month-view__days__day abbr[aria-label='December 20, 2000']"));
		date20th.click();
		
		
		// get text
		// //div[@class='react-date-picker__inputGroup']
		WebElement expectedDate = driver.findElement(By.cssSelector(".react-date-picker__inputGroup__input.react-date-picker__inputGroup__month"));
		System.out.println("Expected Date : "+ expectedDate.getText());
